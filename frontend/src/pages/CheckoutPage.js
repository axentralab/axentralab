...
export default function CheckoutPage() {
  ...
  return (
    <>
      {/* FIX: responsive breakpoint — single column below 680px */}
      <style>{`
        .checkout-grid {
          display: grid;
      ...
      <div style={{ padding: '100px 5% 80px', minHeight: '100vh' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <div className="checkout-grid">
            ...
            <div>
              <div className="checkout-summary-sticky" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 18, padding: 28 }}>
