...
export default function CartPage() {
  ...
  return (
    <>
      {/* FIX: responsive breakpoint — single column on mobile */}
      <style>{`
        .cart-grid {
          display: grid;
      ...
      <div style={{ padding: '100px 5% 80px', minHeight: '100vh' }}>
        ...
        <div className="cart-grid">
          ...
          {/* Summary */}
          <div>
            <div className="cart-summary-sticky" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 18, padding: 28, position: 'sticky', top: 80 }}>
